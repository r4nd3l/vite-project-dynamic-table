...
export const reusableTableConfiguration: TableConfig = {
  /*
  ...
  */
  ...
  /*
    component(s) or native elements per column
    use "undefined" for no content
  */
  //   cellContent: [
  ...
  */
  cellContent: [
    [{ is: Pill, props: ({ value }) => ({ text: String(value), klass: "bg-emerald-600 text-white" }) }, undefined, undefined],
